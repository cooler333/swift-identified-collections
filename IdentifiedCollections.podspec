#
#  Be sure to run `pod spec lint IdentifiedCollections.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.2.1"
  spec.summary      = "A short description of IdentifiedCollections."
  ...
  spec.source       = { :git => "https://github.com/cooler333/swift-identified-collections.git", :tag => "#{spec.version}" }
